...
const fieldGroupStyles = tv({
	base: [
		'group flex h-10 items-center overflow-hidden rounded-lg border-2 border-input bg-bg transition disabled:bg-secondary disabled:opacity-50 forced-colors:bg-[Field]',
